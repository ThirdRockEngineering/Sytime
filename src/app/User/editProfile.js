...
const EditProfile = ({ haveAccount, readProfile, profile, setEdit, handleClose }) => {
  ...
  return (
    <Box component="form" onSubmit={setAccount} gridColumn="span 12" p={1}>
      ...
      <br></br>
      <TextField label="Username" defaultValue={name} onChange={e => setName(e.target.value)} fullWidth />
      <br></br><br></br>
      <TextField label="Avatar(Link-only)" defaultValue={avatar} onChange={e => setAvatar(e.target.value)} fullWidth />
      <br></br><br></br>
      <TextField label="Description" defaultValue={description} onChange={e => setDescription(e.target.value)} fullWidth multiline={true} />
      <br></br><br></br>
